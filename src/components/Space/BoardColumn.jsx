...
const BoardColumn = ({title, id}) => {
    ...
    return (
        <div className='flex flex-col'>
            <Link to={`/board/${id}`}>
                <button>
                    <div className='bg-zinc-100 flex flex-col border-2 text-zinc-700 text-center justify-center items-center w-72 h-36 rounded-lg p-4 pb-4 shadow-lg space-y-4 hover:border-zinc-300 hover:bg-zinc-300 transition-colors ease-in-out duration-300'>
